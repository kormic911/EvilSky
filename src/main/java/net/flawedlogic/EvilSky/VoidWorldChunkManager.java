...
import net.flawedlogic.EvilSky.generators.IPlatformGenerator;
...
public class VoidWorldChunkManager extends WorldChunkManager
{
    ...
    {
        FMLLog.info("[EvilSky] Building spawn platform at: %d, %d, %d", x, y, z);
        IPlatformGenerator platform = EvilSky.instance.getPlatformType(world);
